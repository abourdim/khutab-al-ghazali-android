# Play Store listing — Khutab al-Ghazali (خطب الغزالي)
...
- **Package name**: `org.workshopdiy.khutabalghazali`
...
```
كتاب "خطب الغزالي" تطبيق تفاعلي — للشيخ محمد الغزالي
```

### Full description (≤4000 chars)
```
📖 خطب الغزالي — تطبيق تفاعلي

تطبيق تفاعلي ثلاثي اللغة (عربي/إنجليزي/فرنسي) مستوحى من كتاب "خطب الغزالي" للشيخ محمد الغزالي رحمه الله (1917–1996).
...
• كتاب "خطب الغزالي" — الشيخ محمد الغزالي
...
### App name
```
Khutab al-Ghazali — Ghazali's Sermons
```

### Short description
```
"Ghazali's Sermons" — interactive trilingual app by Sheikh al-Ghazali
```
...
Interactive trilingual app (Arabic / English / French) based on the book "Ghazali's Sermons" by Sheikh Mohammed al-Ghazali (1917–1996).
...
• "Ghazali's Sermons" — Sheikh Mohammed al-Ghazali
...
### App name
```
Khutab al-Ghazali — Khutab al-Ghazali
```

### Short description
```
« Ghazali's Sermons » — application trilingue par Cheikh al-Ghazali
```
...
Application interactive trilingue (arabe / anglais / français) inspirée du livre « Ghazali's Sermons » du Cheikh Mohammed al-Ghazali (1917–1996).
...
• « Ghazali's Sermons » — Cheikh Mohammed al-Ghazali
...
```
Privacy Policy — Khutab al-Ghazali
Last updated: 2026-04-26

The Khutab al-Ghazali app does not collect, store, transmit, or share any personal
